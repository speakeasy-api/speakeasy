...
* [speakeasy generate](generate/README.md)	 - Generate Client SDKs, OpenAPI specs (coming soon) and more (coming soon)
* [speakeasy validate](validate/README.md)	 - Validate OpenAPI schemas + more (coming soon)
