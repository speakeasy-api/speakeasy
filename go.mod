...
require (
	...
	github.com/speakeasy-api/openapi-generation/v2 v2.801.2
	github.com/speakeasy-api/sdk-gen-config v1.46.0
	github.com/speakeasy-api/speakeasy-agent-mode-content v0.1.1
