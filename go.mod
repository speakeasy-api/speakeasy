...
require (
	...
	github.com/speakeasy-api/openapi-generation/v2 v2.169.0
...
require (
	...
	github.com/pb33f/libopenapi-validator v0.0.20 // indirect
	...
	github.com/speakeasy-api/sdk-docs-wrapper v0.0.4 // indirect
