...
require (
	...
	github.com/speakeasy-api/openapi-generation/v2 v2.563.0
	github.com/speakeasy-api/openapi-overlay v0.10.1
	github.com/speakeasy-api/sdk-gen-config v1.30.12
	github.com/speakeasy-api/speakeasy-client-sdk-go/v3 v3.26.0
