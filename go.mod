...
require (
	...
	github.com/speakeasy-api/openapi-generation/v2 v2.276.1
	...
	github.com/speakeasy-api/speakeasy-core v0.1.4
...
require (
	...
	github.com/speakeasy-api/easytemplate v0.9.0 // indirect
