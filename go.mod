...
require (
	...
	github.com/speakeasy-api/openapi-generation/v2 v2.390.0
	...
	github.com/speakeasy-api/speakeasy-client-sdk-go/v3 v3.11.0
	github.com/speakeasy-api/speakeasy-core v0.12.2
