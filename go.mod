...
require (
	...
	github.com/speakeasy-api/openapi-generation/v2 v2.319.10
	github.com/speakeasy-api/openapi-overlay v0.5.0
	github.com/speakeasy-api/sdk-gen-config v1.14.0
	github.com/speakeasy-api/speakeasy-client-sdk-go/v3 v3.5.10
	github.com/speakeasy-api/speakeasy-core v0.8.2
