...
replace github.com/speakeasy-api/openapi-generation/v2 v2.503.2 => /home/qynn/SpeakEasy/openapi-generation
...
require (
	...
	github.com/speakeasy-api/openapi-generation/v2 v2.503.2
