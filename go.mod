...
require (
	...
	github.com/speakeasy-api/openapi-generation/v2 v2.446.5
	github.com/speakeasy-api/openapi-overlay v0.9.0
	github.com/speakeasy-api/sdk-gen-config v1.25.0
	github.com/speakeasy-api/speakeasy-client-sdk-go/v3 v3.15.1
