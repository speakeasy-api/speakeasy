...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.12.2",
			GenVersion:        "2.540.1",
			UserAgent:         "speakeasy-sdk/go 0.12.2 2.540.1 1.0.0 github.com/speakeasy-api/speakeasy/internal/studio/sdk",
			ServerDefaults: []map[string]string{
				{
					"port": "8080",
				},
...
func (s *SDK) CancelRun(ctx context.Context, opts ...operations.Option) (*operations.CancelRunResponse, error) {
