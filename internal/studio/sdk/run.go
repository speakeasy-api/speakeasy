...
func (s *Run) GetLastOutput(ctx context.Context, opts ...operations.Option) (*operations.GetRunResponse, error) {
...
func (s *Run) RegenerateTargets(ctx context.Context, request operations.RunRequestBody, opts ...operations.Option) (*operations.RunResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "run",
		OAuth2Scopes:   []string{},
