...
func New(opts ...SDKOption) *SpekaeasyStudio {
	sdk := &SpekaeasyStudio{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.1.2",
			GenVersion:        "2.384.4",
			UserAgent:         "speakeasy-sdk/go 0.1.2 2.384.4 1.0.0 github.com/speakeasy-api/speakeasy/internal/run/studio/generated-studio-sdk",
			ServerDefaults: []map[string]string{
				{
					"port": "8080",
				},
...
func (s *SpekaeasyStudio) GetRun(ctx context.Context, opts ...operations.Option) (*operations.GetRunResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "getRun",
		OAuth2Scopes:   []string{},
