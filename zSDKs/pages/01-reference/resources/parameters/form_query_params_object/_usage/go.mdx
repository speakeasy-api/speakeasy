```go showLineNumbers copy filename="Form Query Params Object usage example"
package main
...
func main() {
    ...
    res, err := s.Parameters.FormQueryParamsObject(ctx, operations.FormQueryParamsObjectRequest{
        ObjParam: &shared.SimpleObject{
            ...
            BigintStr: big.NewInt(24313),
            Bool: true,
            BoolOpt: openapi.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
            Decimal: types.MustNewDecimalFromString("4255.08"),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
        ...
        ObjParamExploded: shared.SimpleObject{
            Any: "Solutions",
            Bigint: big.NewInt(279068),
            BigintStr: big.NewInt(968865),
            Bool: true,
            BoolOpt: openapi.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
            Decimal: types.MustNewDecimalFromString("2097.5"),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
