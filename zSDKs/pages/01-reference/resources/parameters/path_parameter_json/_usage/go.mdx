```go showLineNumbers copy filename="Path Parameter Json usage example"
package main
...
func main() {
    ...
    res, err := s.Parameters.PathParameterJSON(ctx, operations.PathParameterJSONRequest{
        JSONObj: shared.SimpleObject{
            Any: "drat",
            Bigint: big.NewInt(592081),
            BigintStr: big.NewInt(337477),
            Bool: true,
            BoolOpt: openapi.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
            Decimal: types.MustNewDecimalFromString("4317.85"),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
