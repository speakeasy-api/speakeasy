```go showLineNumbers copy filename="Header Params Object usage example"
package main
...
func main() {
    ...
    res, err := s.Parameters.HeaderParamsObject(ctx, operations.HeaderParamsObjectRequest{
        XHeaderObj: shared.SimpleObject{
            Any: "Northeast",
            Bigint: big.NewInt(442036),
            BigintStr: big.NewInt(991142),
            Bool: true,
            BoolOpt: openapi.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
            Decimal: types.MustNewDecimalFromString("5199.52"),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
        ...
        XHeaderObjExplode: shared.SimpleObject{
            Any: "Diesel",
            Bigint: big.NewInt(461007),
            BigintStr: big.NewInt(227759),
            Bool: true,
            BoolOpt: openapi.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
            Decimal: types.MustNewDecimalFromString("8268.25"),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
