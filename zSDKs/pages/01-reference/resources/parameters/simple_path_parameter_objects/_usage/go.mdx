```go showLineNumbers copy filename="Simple Path Parameter Objects usage example"
package main
...
func main() {
    ...
    res, err := s.Parameters.SimplePathParameterObjects(ctx, operations.SimplePathParameterObjectsRequest{
        ObjParam: shared.SimpleObject{
            Any: "Salad",
            Bigint: big.NewInt(764562),
            BigintStr: big.NewInt(113486),
            Bool: true,
            BoolOpt: openapi.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
            Decimal: types.MustNewDecimalFromString("6982.49"),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
        ...
        ObjParamExploded: shared.SimpleObject{
            ...
            BigintStr: big.NewInt(62636),
            Bool: true,
            BoolOpt: openapi.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
            Decimal: types.MustNewDecimalFromString("216.88"),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
