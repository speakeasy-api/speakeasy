```go showLineNumbers copy filename="Request Body Post Application Json Simple usage example"
package main
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONSimple(ctx, shared.SimpleObject{
        Any: "nulla",
        Bigint: big.NewInt(643678),
        BigintStr: big.NewInt(458503),
        Bool: true,
        BoolOpt: openapi.Bool(true),
        Date: types.MustDateFromString("2020-01-01"),
        DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
        Decimal: types.MustNewDecimalFromString("3644.63"),
        Enum: shared.EnumTwo,
        Float32: 2.2222222,
        Int: 999999,
        Int32: 1,
