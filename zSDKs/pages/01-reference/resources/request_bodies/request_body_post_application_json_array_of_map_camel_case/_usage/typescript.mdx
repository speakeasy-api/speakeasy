```typescript showLineNumbers copy filename="Request Body Post Application Json Array Of Map Camel Case usage example"
import { SDK } from "openapi";
import { RequestBodyPostApplicationJsonArrayOfMapCamelCaseResponse1 } from "openapi/dist/sdk/models/operations";
...
sdk.requestBodies.requestBodyPostApplicationJsonArrayOfMapCamelCase([
  {
    "impedit": {
      anyVal: "theft",
      bigintStrVal: "Account afore magenta",
      bigintVal: 675689,
      boolOptVal: true,
      boolVal: true,
...
]).then((res: RequestBodyPostApplicationJsonArrayOfMapCamelCaseResponse1) => {
