```go showLineNumbers copy filename="Request Body Post Application Json Map Obj usage example"
package main
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONMapObj(ctx, map[string]shared.SimpleObject{
        "doloribus": shared.SimpleObject{
            Any: "when",
            Bigint: big.NewInt(579681),
            BigintStr: big.NewInt(364544),
            Bool: true,
            BoolOpt: openapi.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
            Decimal: types.MustNewDecimalFromString("4558.98"),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
