```typescript showLineNumbers copy filename="Request Body Post Application Json Map Camel Case usage example"
import { SDK } from "openapi";
import { RequestBodyPostApplicationJsonMapCamelCaseResponse1 } from "openapi/dist/sdk/models/operations";
...
sdk.requestBodies.requestBodyPostApplicationJsonMapCamelCase({
  "quos": {
    anyVal: "Diesel",
    bigintStrVal: "Turkmenistan North",
    bigintVal: 517137,
    boolOptVal: true,
    boolVal: true,
...
}).then((res: RequestBodyPostApplicationJsonMapCamelCaseResponse1) => {
