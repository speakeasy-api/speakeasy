```go showLineNumbers copy filename="Request Body Post Application Json Map usage example"
package main
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONMap(ctx, map[string]shared.SimpleObject{
        "porro": shared.SimpleObject{
            Any: "Dobra",
            Bigint: big.NewInt(388319),
            BigintStr: big.NewInt(927212),
            Bool: true,
            BoolOpt: openapi.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
            Decimal: types.MustNewDecimalFromString("1603.93"),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
