```go showLineNumbers copy filename="Request Body Post Form Simple usage example"
package main
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostFormSimple(ctx, shared.SimpleObject{
        Any: "Convertible",
        Bigint: big.NewInt(264333),
        BigintStr: big.NewInt(208253),
        Bool: true,
        BoolOpt: openapi.Bool(true),
        Date: types.MustDateFromString("2020-01-01"),
        DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
        Decimal: types.MustNewDecimalFromString("3483.57"),
        Enum: shared.EnumTwo,
        Float32: 2.2222222,
        Int: 999999,
        Int32: 1,
