```typescript showLineNumbers copy filename="Request Body Post Application Json Array Obj Camel Case usage example"
import { SDK } from "openapi";
import { RequestBodyPostApplicationJsonArrayObjCamelCaseResponse1 } from "openapi/dist/sdk/models/operations";
...
]).then((res: RequestBodyPostApplicationJsonArrayObjCamelCaseResponse1) => {
