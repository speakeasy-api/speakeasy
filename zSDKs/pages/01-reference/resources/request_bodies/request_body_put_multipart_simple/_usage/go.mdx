```go showLineNumbers copy filename="Request Body Put Multipart Simple usage example"
package main
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPutMultipartSimple(ctx, shared.SimpleObject{
        Any: "Nissan",
        Bigint: big.NewInt(725574),
        BigintStr: big.NewInt(244032),
        Bool: true,
        BoolOpt: openapi.Bool(true),
        Date: types.MustDateFromString("2020-01-01"),
        DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
        Decimal: types.MustNewDecimalFromString("385.57"),
        Enum: shared.EnumTwo,
        Float32: 2.2222222,
        Int: 999999,
        Int32: 1,
