```typescript showLineNumbers copy filename="Request Body Post Application Json Array Of Array Camel Case usage example"
import { SDK } from "openapi";
import { RequestBodyPostApplicationJsonArrayOfArrayCamelCaseResponse1 } from "openapi/dist/sdk/models/operations";
...
]).then((res: RequestBodyPostApplicationJsonArrayOfArrayCamelCaseResponse1) => {
