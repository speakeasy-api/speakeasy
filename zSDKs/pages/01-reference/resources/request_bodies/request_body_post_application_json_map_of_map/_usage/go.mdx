```go showLineNumbers copy filename="Request Body Post Application Json Map Of Map usage example"
package main
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONMapOfMap(ctx, map[string]map[string]shared.SimpleObject{
        "eos": map[string]shared.SimpleObject{
            "occaecati": shared.SimpleObject{
                Any: "Cisgender",
                Bigint: big.NewInt(686362),
                BigintStr: big.NewInt(881897),
                Bool: true,
                BoolOpt: openapi.Bool(true),
                Date: types.MustDateFromString("2020-01-01"),
                DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
                Decimal: types.MustNewDecimalFromString("9768.02"),
                Enum: shared.EnumTwo,
                Float32: 2.2222222,
                Int: 999999,
                Int32: 1,
