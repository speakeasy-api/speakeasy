```go showLineNumbers copy filename="Request Body Post Application Json Simple Camel Case usage example"
package main
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONSimpleCamelCase(ctx, shared.SimpleObjectCamelCase{
        AnyVal: "interfaces",
        BigintStrVal: big.NewInt(880679),
        BigintVal: big.NewInt(774684),
        ...
        DecimalVal: types.MustNewDecimalFromString("9450.27"),
