```go showLineNumbers copy filename="Request Body Post Application Json Multiple Json Filtered usage example"
package main
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONMultipleJSONFiltered(ctx, shared.SimpleObject{
        Any: "global",
        Bigint: big.NewInt(1383),
        BigintStr: big.NewInt(93894),
        Bool: true,
        BoolOpt: openapi.Bool(true),
        Date: types.MustDateFromString("2020-01-01"),
        DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
        Decimal: types.MustNewDecimalFromString("2476.85"),
        Enum: shared.EnumTwo,
        Float32: 2.2222222,
        Int: 999999,
        Int32: 1,
