```go showLineNumbers copy filename="Request Body Post Application Json Array Camel Case usage example"
package main
...
func main() {
    ...
    res, err := s.RequestBodies.RequestBodyPostApplicationJSONArrayCamelCase(ctx, []shared.SimpleObjectCamelCase{
        shared.SimpleObjectCamelCase{
            AnyVal: "customer",
            BigintStrVal: big.NewInt(169025),
            BigintVal: big.NewInt(984934),
            ...
            DecimalVal: types.MustNewDecimalFromString("8595.81"),
