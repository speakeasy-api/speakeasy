```go showLineNumbers copy filename="Component Body And Param Conflict usage example"
package main
...
func main() {
    ...
    res, err := s.Flattening.ComponentBodyAndParamConflict(ctx, operations.ComponentBodyAndParamConflictRequest{
        SimpleObject: shared.SimpleObject{
            ...
            BigintStr: big.NewInt(952792),
            Bool: true,
            BoolOpt: openapi.Bool(true),
            Date: types.MustDateFromString("2020-01-01"),
            DateTime: types.MustTimeFromString("2020-01-01T00:00:00.000Z"),
            Decimal: types.MustNewDecimalFromString("4561.3"),
            Enum: shared.EnumTwo,
            Float32: 2.2222222,
            Int: 999999,
            Int32: 1,
